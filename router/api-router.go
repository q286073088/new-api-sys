	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.DisableCache(), middleware.UserAuth())
			{
				...
				selfRoute.GET("/self/announcement-views", controller.GetAnnouncementViews)
				selfRoute.POST("/self/announcement-views", controller.MarkAnnouncementViewed)
				...
				selfRoute.GET("/referrals", controller.GetReferralInvitees)
				selfRoute.GET("/referrals/summary", controller.GetReferralSummary)
				selfRoute.GET("/referrals/rewards", controller.GetReferralRewards)
				selfRoute.GET("/invoice/summary", controller.GetInvoiceSummary)
				selfRoute.GET("/invoice", controller.GetUserInvoices)
				selfRoute.POST("/invoice", middleware.CriticalRateLimit(), controller.CreateUserInvoice)
				selfRoute.GET("/invoice/:id/file", controller.GetInvoiceFile)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/topup/details", controller.GetTopUpDetails)
				adminRoute.GET("/topup/details/:id", controller.GetTopUpDetail)
				adminRoute.GET("/topup/details/summary/:userId", controller.GetTopUpDetailSummary)
		...
		qualityAdmin.GET("/options", controller.QualityTestOptions)
		qualityAdmin.GET("/judge", controller.GetQualityJudge)
		qualityAdmin.PUT("/judge", controller.SaveQualityJudge)
		qualityAdmin.GET("/summary", controller.QualitySummary)
		qualityAdmin.GET("/results", controller.ListQualityResults)
		qualityAdmin.GET("/results/:id", controller.GetQualityResult)
		qualityAdmin.PUT("/:id", controller.SaveQualityTest)
		qualityAdmin.PATCH("/:id", controller.UpdateQualityTestFlags)
		qualityAdmin.DELETE("/:id", controller.DeleteQualityTest)
		qualityAdmin.POST("/:id/run", controller.RunQualityTest)
		qualityPublic := apiRouter.Group("/quality-test-results", middleware.UserAuth())
		qualityPublic.GET("", controller.ListQualityTests)
		qualityPublic.GET("/summary", controller.QualitySummary)
		qualityPublic.GET("/results", controller.ListQualityResults)
		qualityPublic.GET("/results/:id", controller.GetQualityResult)
