...
func TestTopUpDetailsListAndSummary(t *testing.T) {
	...
	assert.Equal(t, int64(3), summary.Get("order_count").Int())
	assert.Equal(t, int64(2), summary.Get("success_count").Int())
	assert.Equal(t, 88.0, summary.Get("total_paid_money").Float())
}
